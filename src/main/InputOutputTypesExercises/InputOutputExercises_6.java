...
public class InputOutputExercises_6 {
    /**
     * Write a Java program to compare two files lexicographically. Go to the editor
     ...
     * is a generalization of the way the alphabetical order of words
     ...
     * (often called words in computer science) of elements of a finite totally ordered set,
     * often called alphabet.
     */
